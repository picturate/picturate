...
ROOT = "https://picturate.github.io/picturate/"

picturate_dir = Path(__file__).resolve().parents[1]
...
def py_to_nb_md(dest_dir):
    for file_path in os.listdir("py/"):
        ...
        github_repo_dir = "picturate/picturate/blob/master/docs/"
...
def nb_to_md(dest_dir):
    notebooks_dir = picturate_dir / "notebooks"
...
if __name__ == "__main__":
    generate(picturate_dir / "docs" / "sources")
