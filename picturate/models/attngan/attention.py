...
def conv1x1(in_planes, out_planes):
    """1x1 convolution with padding on input channels
    Args:
        in_planes (int):  Number of channels in input image
        out_planes (int): Number of channels in output image
    Return:
...
class GlobalAttentionGeneral(nn.Module):
    ...
    def __init__(self, idf, cdf):
        """Constructor function for GlobalAttentionGeneral
        Args:
            cdf:
            idf:
        Returns:
